...
import com.ecommerce.Repository.UnbanRequestRepository;
import com.ecommerce.Repository.UserRepository;
import com.ecommerce.entities.Category;
import com.ecommerce.entities.Comment;
...
public class MainController {
	...
	public String firstHomeView(Model m, Principal principal) {
		...
		m.addAttribute("title", "Ecommerce | Start Shopping Now!");
	...
	public String registerPage(Model m) {
		...
		m.addAttribute("title", "Register | Ecommerce");
	...
	public String loginPage(Model m) {
		...
		m.addAttribute("title", "Login | Ecommerce");
		return "login";
	}
	...
	public String unbanRequestView(Model m) {
		m.addAttribute("title", "Unban Request | Ecommerce");
	...
	*/
	...
	public String showProfile(Model m, Principal principal, HttpSession httpSession) {
		...
		m.addAttribute("title", user.getName() + " | Ecommerce");
		m.addAttribute("user", user);
		return "profile";
	}
	...
	public String checkOut(Model m, Principal principal, HttpSession httpSession) {
		...
		m.addAttribute("title", "Checkout | Ecommerce");
		return "checkout";
	}
